...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_GENERIC_FEM_TWO_CTRL_PINS_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_GENERIC_TWO_CTRL_PINS_SUPPORT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_SIMPLE_GPIO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OS_MGMT_TASKSTAT_USE_THREAD_PRIO_FOR_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OS_MGMT_TASKSTAT_MAX_NUM_THREADS, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OS_MGMT_TASKSTAT_THREAD_NAME_LEN, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OS_MGMT_TASKSTAT_SIGNED_PRIORITY, 1);
